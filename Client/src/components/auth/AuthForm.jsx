...
export default function AuthForm({
  ...
  return (
    <>
      ...
      <h1 className="mb-3 text-xl font-bold text-center text-gray-800 font-Lexend">
        {title}
      </h1>

      {/* Success Message */}
      {success && (
        <div className="p-2 mb-2 text-xs text-green-700 bg-green-100 border border-green-400 rounded-lg">
      ...
      {/* Error Message */}
      {error && (
        <div className="p-2 mb-2 text-xs text-red-700 bg-red-100 border border-red-400 rounded-lg">
          {error}
        </div>
      )}
