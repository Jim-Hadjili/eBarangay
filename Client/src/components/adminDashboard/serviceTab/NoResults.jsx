...
export default function NoResults({ searchQuery, onClear }) {
  return (
    <div className="p-12 mt-10 text-center bg-white border border-gray-200 shadow-sm rounded-xl">
      ...
      <button
        onClick={onClear}
        className="inline-flex items-center gap-2 px-5 py-2.5 text-green-600  bg-green-100 border-2 border-green-400 rounded-lg hover:bg-green-200 transition-all duration-200 font-Lexend"
      >
        Clear Search
      </button>
    </div>
